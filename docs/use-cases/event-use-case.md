...
| **Wallet Functionality Needed** | 1. API that allows for a website to use the wallet as a payment mechanism.<br/> 2. API to save ticket to the wallet.<br/> 3. Ability to view all event tickets in the wallet.<br/> 4. Ability to display a specific ticket with a QR code to gain entry to an event. |
